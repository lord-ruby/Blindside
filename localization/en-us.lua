return {
	["misc"] = {
		["dictionary"] = {
			...
			['bld_playing_with_fire_each_1'] = "$1 each Joker trigger",
			['bld_playing_with_fire_each_2'] = "$2 each Joker trigger",
			['bld_playing_with_fire_each_3'] = "$3 each Joker trigger",
			['bld_playing_with_fire_each_big_joker_1'] = "$1 each Joker XMult",
			['bld_playing_with_fire_each_big_joker_2'] = "$2 each Joker XMult",
	...
	["descriptions"] = {
		...
		["bld_obj_rune"] = {
			...
			["c_bld_arengeesix"] = {
				["name"] = "Arengee",
				["text"] = {
                    "{C:attention}Retrigger{} all scoring blinds",
					"{C:inactive}(Changes each hand)",
                    "{C:inactive}(#1#/#2# Rounds){}"
				},
			},
