            ...
            nodes = {
                {
                    ...
                    config = {
                        scale = 0.3,
                        text = "Blindside BETA PRERELEASE v0.1.0",
